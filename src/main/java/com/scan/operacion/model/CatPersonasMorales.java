...
public class CatPersonasMorales implements Serializable {
    ...
    public CatPersonasMorales(Integer id) {
        this.id = id;
    }
    ...
    public boolean equals(Object object) {
        ...
        if (!(object instanceof CatPersonasMorales)) {
            return false;
        }
        CatPersonasMorales other = (CatPersonasMorales) object;
    ...
    public String toString() {
        return "com.scan.operacion.model.CatPersonasMorales[ id=" + id + " ]";
    }
